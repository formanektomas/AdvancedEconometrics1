...
For the original panel data model (without the $\overline{x}_i$ element included), we can use the expanded CRE specification to test for applicability of FE vs. RE estimation
