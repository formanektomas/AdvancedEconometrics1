...
\begin{frame}{Long panels -- models and estimation}
    \begin{itemize}
        \item Quick repetition of topics from BSc courses
        \bigskip
...
\end{bmatrix} = 
    \sigma^2\bm{I}_N$ 
    \bigskip
    \item[(b)] $\varepsilon_t$ under heteroscedasticity (no \texttt{ar} present)\\ \medskip
...
\end{bmatrix} = 
    \sigma^2\bm{I}_N$ 
    \bigskip
    \item[(d)] $\varepsilon_t$: general case (both heteroscedasticity and \texttt{ar} may be present\\ \medskip
    $\textnormal{var}(\bm{\varepsilon}|\bm{X}) = 
    \begin{bmatrix}
    \sigma^2_1 		& 	0 	& 	\cdots	& 	0 \\
        0 	        & 	\sigma^2_2 		& \cdots 	&  0				\\
