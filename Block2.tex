...
\begin{itemize}
\item Causes and effects of autocorrelation (DGP, dynamic completeness of models; unbiased $\hat{\beta}_j$, biased inference, etc.)
\medskip
...
$$H_0 : \rho = 0$$
(We can use a heteroscedasticity-robust version of the test)
...
\begin{itemize}
\item heteroscedasticity in time series
\vspace{1cm}
\begin{itemize}
\item Autoregressive Conditional heteroscedasticity (ARCH) models included
\end{itemize}
\end{itemize}
\end{frame}
