...
%------------------------------------------------------
\begin{frame}{Serial correlation of the error term in TSRM}
Breusch-Godfrey (BG) test for serial correlation with general regressors (regressors from main equation are used in the auxiliary regression for the BG test). Large sample validity.\\ \medskip
\begin{itemize}
