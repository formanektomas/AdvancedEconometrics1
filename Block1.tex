...
\begin{frame}{Generalized method of moments}
\begin{itemize}
\item GMM equations can be cast by analogy to the MM case: \\ \bigskip we start by $E[\bm{z}_i \varepsilon_i]=\bm{0}$, which implies a \textbf{population moment equation:}
$$
