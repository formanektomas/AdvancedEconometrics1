...
\vspace*{-1.5mm}
\begin{itemize}
\item In most empirical applications, we would use up to six variables (roughly). However, there is no theoretical upper limit for $m$, given adequate time series are availability for model estimation.
\end{itemize}
