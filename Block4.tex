...
\begin{frame}{Instrumental variables}
\centering
\includegraphics[width=0.4\textwidth]{./img/assumptions.jpg}
\end{frame}
%---------------------------------------------
\begin{frame}{Instrumental variables}
\begin{itemize}
...
\begin{itemize}
    ...
    \medskip
    \item Solution: Project $\bm{X}$ to the column space of $\bm{Z}$ (GMM).\\
...
\medskip
SLRM: \quad $y_{i1}=\beta_0+\beta_1 y_{i2}+u_i$; \ $z$ instrument exists
\bigskip
\begin{itemize}
...
\medskip
\begin{itemize}
    \item Theoretically defined relationships modelled
    \item Causal \& ceteris paribus interpretation of coefficients
    \item Different perspectives on DGP (discussed next)
    \item Describe the structure of factors of the DGP
\end{itemize}
\bigskip
